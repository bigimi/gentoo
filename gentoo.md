...
>=x11-libs/libdrm-2.4.134 video_cards_radeon
x11-wm/qtile X
#+++++++++++++++++++++++++++++++
...
#+++++++++++++++++++++++++++++++++++++++++
KERNEL_CONFIG="%entry_id %linux_name Linux %kernel_version ; root=UUID=< your disk uuid> rootfstype=btrfs rootflags=subvol=@ rw"
+++++++++++++++++++++++++++++++++++++++++++
